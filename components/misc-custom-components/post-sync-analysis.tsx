            ...
            {currentResults.matchingGoals.length > 0 && (
                <div className="p-4 border rounded-lg bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-700">
                    ...
                    <div className="space-y-3">
                        {currentResults.matchingGoals.map(({ goal, matchingCreature }) => (
                            <div
                                key={goal.id}
            ...
            {currentResults.archivableCreatures.length > 0 && (
                <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                        The following {currentResults.archivableCreatures.length} creatures were not found
                    ...
                    <ScrollArea className="h-32 mb-4 rounded-md border bg-slate-50 dark:bg-slate-800/50 p-2">
                        <ul className="text-xs list-disc list-inside">
                            {currentResults.archivableCreatures.map((c) => (
                                <li key={c.id}>
