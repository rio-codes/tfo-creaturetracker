...
const newsItems = [
    {
        ...
        content: (
            <>
                <details>
                    <summary>
                        Another week, more new TFOCT features! Since last time, we`&apos;`ve added
                        some fun stuff:
                    </summary>
                    <p>
                        <ul>
                            <li>
                                ...
                                take a screenshot and show off all the cool stuff you`&apos;`ve been
                                up to, knock yourself out!
                            </li>
                            <br />
                            <li>
                                ...
                                now, it has a generation indicator such as `&quot;`G1`&quot;` next
                                to its name. You can also set the origin of G1 creatures to Cupboard
                                or Genome Splicer, and of any creature to `&quot;`Another
                                Lab`&quot;` as well as change the generation manually. We do our
                                best to guess the generation based on your breeding logs, but we
                                can`&apos;`t know what goes on in...Another Lab. <br />
                                <br />
                            ...
                            <li>
                                ...
                                Can`&apos;`t miss it. The random creature is generated by selecting
                                a possible outcome from one of the site`&apos;`s breeding pairs...if
                                you love the creature you see and want to make it a goal let me know
                                and I`&apos;`ll try and dig up the genes!
                            </li>
                            <br />
                            <li>
                                <strong>Bugfixes</strong>
                                <br />
                                We`&apos;`ve fixed some bugs with validating settings data, some
                                layout overflows on mobile, a bug where you couldn`&apos;`t add a
                                second progeny to a breeding log entry, and done some maintenance
                                and cleanup under the hood. If you want to see what`&apos;`s going
                                on under there, one of our useful internal updates is this{' '}
                                <Link
                                    className="text-pompaca-purple dark:text-purple-400 hover:underline font-semibold"
                    ...
                    <p>
                        <ul>
                            <li>
                                ...
                                <br />
                                We have added new icons we call `&quot;`flair`&quot;` to your
                                profile if you are one of our beta testers or Patreon supporters.
                                Beta testers have this microscope: <FlairIcon tier="beta_tester" />.
                                The three Patreon tiers have these creatures:{' '}
                                <FlairIcon tier="postdoc" /> (Postdoc){' '}
                            ...
                            <li>
                                ...
                                logic. Previously if gender was marked as `&quot;`optional`&quot;`
                                on a goal your match score would go down, when it should go up!
                                There`&apos;`s 100% chance of getting a preferred gender, so
                                it`&apos;`s basically a `&quot;`freebie`&quot;` in your calculation.
                                Thanks again to <FlairIcon tier="beta_tester" />
                                <Link
                                    href="/Notherox"
                                    className="text-pompaca-purple dark:text-purple-400 hover:underline font-semibold"
                                >
        ...
        content: (
            <>
                <p>
                    ...
                    breeding creatures in The Final Outpost.{' '}
                    <Link
                        href="/register"
                        className="text-pompaca-purple dark:text-purple-400 hover:underline font-semibold"
                    >
