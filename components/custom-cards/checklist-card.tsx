...
export function ChecklistCard({ checklist }: ChecklistCardProps) {
    ...
    return (
        <Card className="bg-ebena-lavender dark:bg-pompaca-purple hallowsnight:bg-ruzafolio-scarlet flex flex-col h-full transition-transform duration-200 ease-in-out hover:scale-105">
