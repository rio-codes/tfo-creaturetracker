                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Card className="bg-purple-card border-purple-400">
                            ...
                            <CardContent className="space-y-2 text-sm">
                                {Object.entries(researchGoalData.genotype).map(
                                    ([key, value]) => (
                                        <div
                                            key={key}
                    ...
                    <Card className="bg-purple-card border-purple-400">
                        ...
                        <CardContent className="space-y-4">
                            {researchGoalData.breedingPairs.map((pair) => (
                                <div key={pair.id} className="space-y-2">
                                    <div className="text-sm text-purple-900">
                                        <div>
                                            <strong>
                                                WcxHt (The Music of the Spheres)
                                            </strong>{" "}
                                            x{" "}
                                            <strong>
                                                mGKez (The Orchestra Tunes Their
                                                Instruments)
                                            </strong>
                                        </div>
                            ...
                            <div className="space-y-2">
                                <div className="text-sm text-purple-900">
                                    <strong>
                                        XtpXn (Where Did the Conductor Go?)
                                    </strong>{" "}
                                    x{" "}
                                    <strong>
                                        MWsn (An Embarrassment of Riches)
                                    </strong>
                                </div>
                            </div>
                    ...
                    <CardContent>
                        <ScrollArea className="w-full">
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-purple-600 hover:bg-purple-600">
                                        ...
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Body
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Overlay
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Pattern
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Legs
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Wings
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Shield
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Eyes
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                            Chance of Correct Horn
                                        </TableHead>
                                        <TableHead className="text-white font-bold text-center">
                                ...
                                <TableBody>
                                    {researchGoalData.breedingStats.map(
                                        (stat, index) => (
                                            <TableRow
                                                key={index}
                                            ...
                                            >
                                                ...
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectBody}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectOverlay}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectPattern}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectLegs}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectWings}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectShield}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectEyes}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.chanceCorrectHorn}
                                                </TableCell>
                                                <TableCell className="text-center text-purple-900">
                                                    {stat.averageHybridAccuracy}
                                                </TableCell>
                                                <TableCell className="text-center font-bold text-purple-900">
                                                    {stat.anyChanceOfGoal}
                                                </TableCell>
                                                <TableCell className="text-center font-bold text-purple-900">
                                                    {stat.bred}
                                                </TableCell>
