export type RawSpeciesGenes = {
    [species: string]: {
        Dimorphic: 'True' | 'False';
        Gender: string[];
        [category: string]: string[] | 'True' | 'False';
    };
};
...
export type GeneCategory = Gene[];

export type SpeciesGeneData = {
    Dimorphic?: 'True' | 'False';
    [category: string]: GeneCategory | 'True' | 'False' | undefined;
};
...
export const speciesGenes: RawSpeciesGenes = {
    'Abomena Pahidermo': {
        Dimorphic: 'False',
        Gender: ['Male', 'Female'],
        Body: [
    ...
    'Arbara Krono': {
        ...
        Antler: [
            'AABBCC - Chital Velvet - M',
            'AABBCc - Chital - M',
            'AABBcc - Chital Red - M',
            'AABbCC - Rangifer Velvet - M',
            'AABbCc - Rangifer - M',
            'AABbcc - Rangifer Red - M',
            'AAbbCC - Sambar Velvet - M',
            'AAbbCc - Sambar - M',
            'AAbbcc - Sambar Red - M',
            'AaBBCC - Elk Velvet - M',
            'AaBBCc - Elk - M',
            'AaBBcc - Elk Red - M',
            'AaBbCC - Whitetail Velvet - M',
            'AaBbCc - Whitetail - M',
            'AaBbcc - Whitetail Red - M',
            'AabbCC - Red Deer Velvet - M',
            'AabbCc - Red Deer - M',
            'Aabbcc - Red Deer Red - M',
            'aaBBCC - Moose Velvet - M',
            'aaBBCc - Moose - M',
            'aaBBcc - Moose Red - M',
            'aaBbCC - Fallow Velvet - M',
            'aaBbCc - Fallow - M',
            'aaBbcc - Fallow Red - M',
            'aabbCC - Megaloceros Velvet - M',
            'aabbCc - Megaloceros - M',
            'aabbcc - Megaloceros Red - M',
            'AABBCC - None - F',
            'AABBCc - None - F',
            'AABBcc - None - F',
            'AABbCC - None - F',
    ...
    'Luma Mordo': {
        ...
        Tailfins: [
            'AABBCC - Blue Newt - M',
            'AABBCc - Electric Blue Thresher - M',
            'AABBcc - Purple Small Spikes - M',
            'AABbCC - Teal Newt - M',
            'AABbCc - Gray Thresher - M',
            'AABbcc - Purple Spikes - M',
            'AAbbCC - Green Spikes - M',
            'AAbbCc - Copper Betta - M',
            'AAbbcc - Black Horizontal - M',
            'AaBBCC - None - M',
            'AaBBCc - Black Thresher - M',
            'AaBBcc - Purple Thresher - M',
            'AaBbCC - Teal Thresher - M',
            'AaBbCc - Green Small Spikes - M',
            'AaBbcc - Purple Horizontal - M',
            'AabbCC - Green Horizontal - M',
            'AabbCc - Copper Fin - M',
            'Aabbcc - Black Fin - M',
            'aaBBCC - Teal Fin - M',
            'aaBBCc - Blue Thresher - M',
            'aaBBcc - None - M',
            'aaBbCC - Red Spikes - M',
            'aaBbCc - Black Spikes - M',
            'aaBbcc - RedBetta - M',
            'aabbCC - Green Thresher - M',
            'aabbCc - Blue Betta - M',
            'aabbcc - Black Small Spikes - M',
            'AABBCC - Blue Betta - F', 
            'AABBCc - Electric Blue Thresher - F',
            'AABBcc - Purple Newt - F',
            'AABbCC - Teal Newt - F',
            'AABbCc - Gray Shark - F',
            'AABbcc - Purple Spikes - F',
            'AAbbCC - Green Shark - F',
            'AAbbCc - Copper Betta - F',
            'AAbbcc - Black Thresher - F',
            'AaBBCC - None - F',
            'AaBBCc - Electric Blue Back Scales - F',
            'AaBBcc - Purple Shark - F',
            'AaBbCC - Teal Thresher - F',
            'AaBbCc - Green Tattered - F',
            'AaBbcc - Red Betta - F',
            'AabbCC - Green Spikes - F',
            'AabbCc - Copper Back Scales - F',
            'Aabbcc - Black Spikes - F',
            'aaBBCC - Blue Newt - F', 
            'aaBBCc - Blue Tattered -F',
            'aaBBcc - None - F', 
            'aaBbCC - Red Shark Fin - F',
            'aaBbCc - Black Thresher - F',
            'aaBbCc - Black Horizontal Fin - F', 
            'aaBbcc - Red Back Scales - F',
            'aabbCC - Green Tattered - F',
            'aabbCc - Red Horizontal - F',
            'aabbcc - Black Horizontal - F'
        ],
        Variation: [
            'AABB - Sawfish - M',
            'AABb - Hammerhead - M',
    ...
    'Sabla Rego': {
        Dimorphic: 'True',
        Gender: ['Male', 'Female'],
        Body: ['AA - Firelit - M', 'Aa - Black - M', 'aa - Brown - M', 'AA - Gray - F', 'Aa - Dark green - F', 'aa - Light purple - F'],
        Markings: ['AA - Skeleton', 'Aa - none', 'aa - none'],
        Horns: ['AA - Gold - M', 'Aa - Gray - M ', 'aa - Bone - M', 'AA - Red - F', 'Aa - Pink - F', 'aa - Gray - F'],
    },
    Saltanta: {
        Dimorphic: 'False',
        Gender: ['Male', 'Female'],
...
export const structuredGeneData: AllSpeciesGeneData = (() => {
    const structuredData: AllSpeciesGeneData = {};

    for (const species in speciesGenes) {
        const speciesData = (speciesGenes as any)[species];
        const structuredSpeciesData: SpeciesGeneData = {};
        structuredSpeciesData.Dimorphic = speciesData.Dimorphic;
        const isDimorphic = speciesData.Dimorphic === 'True';

        for (const category in speciesData) {
            if (category === 'Dimorphic') continue;

            const genes = speciesData[category];
            const geneData: Gene[] = [];

            if (Array.isArray(genes)) {
                for (const geneString of genes) {
                    if (typeof geneString !== 'string') continue;

                    const parts = geneString.split(' - ').map((p) => p.trim());
                    if (parts.length >= 2) {
                        const gene: Gene = {
                            genotype: parts[0],
                            phenotype: parts[1],
                        ...
                        if (isDimorphic && parts.length > 2) {
                            const genderMarker = parts[2].toUpperCase();
                            if (genderMarker === 'M') gene.gender = 'Male';
                            if (genderMarker === 'F') gene.gender = 'Female';
                        } else if (category === 'Gender') {
                            gene.phenotype = gene.genotype;
                        }

                        geneData.push(gene);
                    } else if (parts.length === 1 && category === 'Gender') {
                        geneData.push({
                            genotype: parts[0],
                            phenotype: parts[0],
                        });
            ...
            structuredSpeciesData[category] = geneData;
        }
        structuredData[species] = structuredSpeciesData;
    }
